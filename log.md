...
**Thoughts**: Basic functionality is all there, and all tests are passing. Next, I want to finalize styling and content.  
...
**Thoughts**: Still sick AF today. This is an interesting way to think about constructing things.
...
**Thoughts**: Finally feeling better :D Enjoyed playing with logic today, and then modified one of the challenges to my own ends (numbers based on research data).
